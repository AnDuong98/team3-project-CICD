...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Handles InvalidSearchParamException
     *
     * @param ex the InvalidSearchParamException
     * @return the ApiError object
     */
    @ExceptionHandler(InvalidSearchParamException.class)
    protected ResponseEntity<Object> handleInvalidSearchParamException(
    		InvalidSearchParamException ex){
